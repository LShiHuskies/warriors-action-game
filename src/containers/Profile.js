...
class Profile extends Component {
  ...
  handleHighScores = () =>{
    ...
    if (this.state.games == null) {
      ...
      fetch(`http://${warriorbackend.herokuapp.com}:3000/api/games/`,
        {headers: {
  ...
  handleStartGame = (event) => {
    ...
    fetch(`http://${warriorbackend.herokuapp.com}:3000/api/users/${this.props.player.id}`, config).then(r => r.json())
