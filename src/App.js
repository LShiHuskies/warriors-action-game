...
class App extends Component {
  ...
  makeFetchForScore = () => {
    ...
    fetch(`http://${warriorbackend.herokuapp.com}:3000/api/moves`, config).then(r=> r.json())
  ...
  handleSubmit = (event) => {
    ...
    if (event.target.value === "Login") {
      ...
      fetch(`http://${warriorbackend.herokuapp.com}:3000/api/sessions`, {
        method: 'POST',
        headers: {
          'Content-Type': "application/json"
        },
      ...
      fetch(`http://${warriorbackend.herokuapp.com}:3000/api/users`, {
        method: 'POST',
        headers: {
          'Content-Type': "application/json"
        },
